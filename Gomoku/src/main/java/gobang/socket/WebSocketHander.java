package gobang.socket;

import org.apache.log4j.Logger;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;
import org.springframework.web.socket.*;
import gobang.rooms.RoomHandler;
...
//		String rooms;
//		RoomHandler h = new RoomHandler();
//		rooms = h.getAllRoom();
//		sendMessageToAllSession(new TextMessage("m"+rooms));
	}
	...
	public void handleMessage(WebSocketSession webSocketSession, WebSocketMessage<?> webSocketMessage)
			throws Exception {
		//处理用户请求
		String req = webSocketMessage.getPayload()+"";
		System.out.println("请求"+req);
		if(req.contains("java")){//忽略java.nio.HeapByteBuffer[pos=0 lim=0 cap=0]
